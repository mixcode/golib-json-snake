...
func TestRoundtripStringTagLowerCamelCase(t *testing.T) {
	tests := []struct {
		name string
		in   StringTag
		want string // empty to just test that we roundtrip
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			// Indent with a tab prefix to make the multi-line string
			// literals in the table nicer to read.
			got, err := MarshalIndentAs(&test.in, "\t\t\t", "\t", LowerCamelCase, false)
			if err != nil {
				t.Fatal(err)
			}
			if got := string(got); got != test.want {
...
func TestRoundtripStringTagSnakeCase(t *testing.T) {
	tests := []struct {
		name string
		in   StringTag
		want string // empty to just test that we roundtrip
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			// Indent with a tab prefix to make the multi-line string
			// literals in the table nicer to read.
			got, err := MarshalIndentAs(&test.in, "\t\t\t", "\t", SnakeCase, false)
			if err != nil {
				t.Fatal(err)
			}
			if got := string(got); got != test.want {
...
func TestRoundtripStringTagLowerCase(t *testing.T) {
	tests := []struct {
		name string
		in   StringTag
		want string // empty to just test that we roundtrip
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			// Indent with a tab prefix to make the multi-line string
			// literals in the table nicer to read.
			got, err := MarshalIndentAs(&test.in, "\t\t\t", "\t", LowerCase, false)
			if err != nil {
				t.Fatal(err)
			}
			if got := string(got); got != test.want {
